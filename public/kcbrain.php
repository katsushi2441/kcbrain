  ...
  <div class="workspace">
    <section class="panel">
      ...
      <div class="panel-body">
        ...
        <div class="quick-input"><div><strong>分析対象</strong><p>対象を選び、そのまま実行できます。</p></div><div class="toolbar"><button class="tool active" id="btcPreset">Bitcoin</button><button class="tool" id="ethPreset">Ethereum</button></div></div>
...
function setTarget(name){document.querySelectorAll('.quick-input .tool').forEach(x=>x.classList.remove('active'));if(name==='btc')document.querySelector('#btcPreset').classList.add('active');if(name==='eth')document.querySelector('#ethPreset').classList.add('active')}
